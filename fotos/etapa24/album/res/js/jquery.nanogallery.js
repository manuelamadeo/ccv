...
//        ch='';
    ...
    function OpenInternalViewer( imageIdx ) {
      ...
      if( G.O.viewerDisplayLogo ) {
        G.$E.vwLogo=jQuery('<div class="nanoLogo"><div class="credit" style="color:#fff;">Un-Registered <br> <a href="http://www.jalbumskins.com/#nano"><i class="fa fa-th"></i> Nano Skin</a></div></div>').appendTo(G.$E.conVw);
      }
